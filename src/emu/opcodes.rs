use crate::emu::cpu::AddressingMode;
...
pub static CPU_OPS_CODES: Lazy<Vec<OpCode>> = Lazy::new(|| {
    vec![
        ...
        OpCode::new(0xd0, "BNE", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0x70, "BVS", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0x50, "BVC", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0x30, "BMI", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0xf0, "BEQ", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0xb0, "BCS", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0x90, "BCC", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        OpCode::new(0x10, "BPL", 2, 2/*+1 if to a new page*/, AddressingMode::NoneAddressing),
        ...
        OpCode::new(0xe2, "*NOP", 2, 3, AddressingMode::Immediate),
...
pub static OPECODES_MAP: Lazy<HashMap<u8, &'static OpCode>> = Lazy::new(|| {
